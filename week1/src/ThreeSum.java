...
/******************************************************************************
 Note: in cmd, compile and run use javac -cp ...\algs.jar ThreeSum.java || 
 java -cp ...\algs.jar ThreeSum ...\1Kints.txt

 Property: The order of growth of the running time of ThreeSum is N^3
 Proposition: The brute-force 3-sum algorithm uses ~N^3/2 array accesses \
